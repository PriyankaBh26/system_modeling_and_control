...
VectorXd UnscentedKalmanFilter::f(VectorXd x, VectorXd Bu) {
    VectorXd xd(n);
...
VectorXd UnscentedKalmanFilter::h(VectorXd x) {
    VectorXd y(n);
    MatrixXd H(m, n);
    H << 1, 0,
        0, 0;
...
int main() {
    ...
    UnscentedKalmanFilter* ukf = new UnscentedKalmanFilter(x0_m, P0, 
                                                        Q, R, 
                                                        dt, num_states, 
                                                        num_outputs, kappa);
