...
SRCS="test/multi_joint_robots/test_serial_chain_robot_dynamics.cpp 
      src/multi_joint_robots/serial_chain_robot_helper_funs.cpp
      src/multi_joint_robots/serial_chain_robot_dynamics.cpp"
